...
def display_output(breath_count, roi_binary, roi, roi_thermal, clone, cap1_frame):
    """
       Display the real time frame in a secondary display

        :param breath_count: realtime breath count
        :param roi_binary: extracted region of interest from binary image
        :param roi: extracted region of interest from web camera
        :param roi_thermal: extracted region of interest from thermal camera
        :param clone: clone of the original web camera image
        :param cap1_frame: original thermal camera image
    """
